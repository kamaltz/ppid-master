        ...
        <div className="mb-6">
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-red-800">Informasi Batas Harian</h3>
                <div className="mt-2 text-sm text-red-700">
                  <p>• Maksimal 3 keberatan per hari</p>
                  <p>• Setiap permohonan hanya dapat diajukan 1 keberatan</p>
                </div>
              </div>
            </div>
          </div>
